...
This library is part of the [Aurelia](http://www.aurelia.io/) platform and is a place to store TypeScript Definition Files which Aurelia developers may need, but which aren't available elsewhere.
